...
public class TestData {
	...
	public Object[][] getdata() throws BiffException, IOException {
		...
		FileInputStream excel = new FileInputStream("C:\\Users\\User\\Desktop\\Book5.xls");
	...
	public void Login(String email, String password) throws InterruptedException {
		...
		driver.get("http://192.168.102.29:4201/account/login");
		Thread.sleep(2000);
		...
		String actualUrl = "http://192.168.102.29:4201/account/login";
		...
		/*
		 * if(username.equals("abimanyu") && password.equals("Abimanyu001")) {
		 * logger.info("Registration successfull"); } else {
		 * logger.info("Registration Failed"); }
		 */
